...
PulseAreaHistogram::PulseAreaHistogram(){

  SetSubTabName("Pulse area");
...
void PulseAreaHistogram::CreateHistograms(){
  ...
  std::cout << "Pulse-area histogram done init...... " << std::endl;
  FrequencySetting = -1;
}


void PulseAreaHistogram::UpdateHistograms(TDataContainer& dataContainer){
